<?php
/**
 * wp_boilerplate Theme Customizer
 *
...
function wp_boilerplate_customize_preview_js() {
	wp_enqueue_script( 'wp_boilerplate-customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), _S_VERSION, true );
}
